...
const FORM_CONFIG: Record<TaskKey, { title: string; description: string; fields: Field[] }> = {
  ...
  comment: {
    title: "Create commentary entry",
    description: "Store a commentary entry.",
    fields: [
...
export default function CreateTaskPage() {
  ...
  const handleSubmit = () => {
    ...
    toast({
      title: taskKey === "article" ? "Saved" : "Saved locally",
      description:
        taskKey === "article"
          ? "Post saved successfully."
          : "This post is stored only in your browser.",
    });
      ...
      <main className="mx-auto max-w-4xl px-4 py-12">
        ...
        <div className="rounded-3xl border border-border bg-card p-8 shadow-sm">
          <div className="flex flex-wrap gap-2">
            ...
            {taskKey === "article" ? null : <Badge variant="outline">Local</Badge>}
          </div>
